...
def generar_preview_corte(
    ...
    instruccion = (
        ...
        "must preserve the same front-facing pose, head angle, expression, "
        "framing and identity from the uploaded photo when that photo is "
        "already facing front. Do not rotate, straighten or reconstruct the "
        "face unnecessarily. The requested haircut MUST be visibly applied "
        "in this top-left front view: replace the original hairstyle there "
        "with the requested haircut, including its specific sides, top, "
        "fringe, texture, volume and hairline. Do not copy the original "
        "front hairstyle unchanged. "
        ...
        "between quadrants. Apply the same requested haircut consistently in "
        ...
        "appearance, but replace the hair in every quadrant.\n\n"
